...
def migrate_questions_from_json(json_file: str = None):
    ...
    Args:
        json_file: Path to questions.json file. Defaults to questions.json in the same directory
    """
    if json_file is None:
        # Default to questions.json in the same directory as this script
        script_dir = os.path.dirname(os.path.abspath(__file__))
        json_file = os.path.join(script_dir, 'questions.json')
